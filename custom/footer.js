...
(function (outerDocument) {
  ...
  // 白天和晚上时 footer 上的内容：
  const footerDay = `<img class='boardsign' src='https://img.shields.io/badge/s1rius-摸鱼中-6adea8?style=social&logo=cakephp' title='距离月入25k也就还差一个大佬带我~'>
<br/>小破站在各种灾难中苟活了<span id="create-time"></span><i id="heartbeat" class='fas fa-heartbeat'></i>
<br/>欢迎参观我的Space✨
<br/>人若无名，便可专心练剑🗡
<br/>
...
`;
  const footerNight = `<img class='boardsign' src='https://img.shields.io/badge/s1rius-打烊休息啦-6adea8?style=social&logo=coffeescript' title='下班了就该开开心心的玩耍，嘿嘿~'>
<br/>小破站在各种灾难中苟活了<span id="create-time"></span><i id="heartbeat" class='fas fa-heartbeat'></i>
<br/>欢迎参观我的Space✨
<br/>
<div id="dkdun" style="display: flex; align-items: center; justify-content: center; cursor: pointer;">
